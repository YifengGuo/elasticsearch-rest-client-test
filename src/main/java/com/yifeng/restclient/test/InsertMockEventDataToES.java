        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (!exists) {
                    ...
                    String indexCommand = "curl -X PUT \"http://172.16.150.149:29200/" + curIndexName + "\"-H 'Content-Type: application/json' -d' { \"settings\" : { \"index\" : { \"number_of_shards\" : 1, \"number_of_replicas\" : 0 } } } '";
                    rt.exec(indexCommand);

                    //  6.0 API does not support es older version
